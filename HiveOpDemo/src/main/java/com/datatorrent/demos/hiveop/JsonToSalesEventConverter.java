...
public class JsonToSalesEventConverter extends BaseOperator
{
  ...
  private static final ObjectReader reader = mapper.reader(new TypeReference<SalesEvent>() { });
  private static final Logger logger = LoggerFactory.getLogger(JsonToSalesEventConverter.class);
  ...
  public final transient DefaultInputPort<byte[]> input = new DefaultInputPort<byte[]>()
  {
    ...
    public void process(byte[] message)
    {
      try {
        ...
        SalesEvent tuple = reader.readValue(message);
   ...
   */
  public final transient DefaultOutputPort<SalesEvent> outputMap = new DefaultOutputPort<SalesEvent>();
